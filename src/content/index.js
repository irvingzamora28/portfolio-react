const data = {
    ...
    header: {
      img:
      process.env.PUBLIC_URL + '/assets/bottles.jpg',
      imgPlaceholder:
    ...
    stack: {
      ...
      tech: [
        {
          img: process.env.PUBLIC_URL + '/assets/mongodb.jpg',
          alt: 'mongodb',
        },
        {
          img: process.env.PUBLIC_URL + '/assets/reactjs.png',
          alt: 'react',
        },
        {
          img: process.env.PUBLIC_URL + '/assets/express.jpg',
          alt: 'express',
        },
        {
          img: process.env.PUBLIC_URL + '/assets/nodejs.jpg',
          alt: 'node',
        },
      ],
