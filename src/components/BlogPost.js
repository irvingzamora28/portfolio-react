        ...
        <div>
            ...
            <div className="container w-full md:max-w-3xl mx-auto pt-20">
                ...
                <div className="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal">
                    ...
                    <p className="text-2xl font-bold pb-3">Introduction</p>
                ...
                <div className="container px-4">
                    <div className="font-sans bg-gradient-to-b from-indigo-100 to-gray-100 rounded-lg shadow-xl p-4 text-center">
                        ...
                        <div className="w-full text-center pt-4">
                            <form action="#">
                                <div className="max-w-xl mx-auto p-1 pr-0 flex flex-wrap items-center">
                                    ...
                                    <button type="submit" className="flex-1 mt-4 block md:inline-block appearance-none bg-indigo-500 text-white text-base font-semibold tracking-wider uppercase py-4 rounded shadow hover:bg-indigo-400">Subscribe</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div className="flex w-full items-center font-sans px-4 py-12">
                    <img className="w-10 h-10 rounded-full mr-4" src="http://i.pravatar.cc/440" alt="Avatar of Author" />
                    <div className="flex-1 px-2">
                        <p className="text-base font-bold text-base md:text-xl leading-none mb-2">Irving Zamora</p>
                        <p className="text-gray-600 text-xs md:text-base">Web Developer</p>
                    </div>
                    <div className="justify-end">
                        <button className="bg-transparent border border-gray-500 hover:border-indigo-500 text-xs text-gray-500 hover:text-indigo-500 font-bold py-2 px-4 rounded-full">Read More</button>
                    </div>
                </div>
