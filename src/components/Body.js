        ...
        <div className=" min-h-screen flex flex-col items-center justify-center text-blue-bottle-light-500" id="body">
            ...
            <div className="flex flex-wrap justify-center mt-10">
                {content.stack.tech.map((tech, index) => {
                    return <span key={index} className={`${index % 2 === 0 ? " animate-float" : "animate-refloat"} w-40 h-40 bg-white shadow-2xl m-2 rounded-full flex items-center p-8`}> <LazyLoadImage src={tech.img} alt={tech.alt} /> </span>
                })}
