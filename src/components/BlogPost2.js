            ...
            <nav className="w-full py-4 border-t border-b bg-gray-100">
                <div className="block sm:hidden">
                    <button
                        ...
                        Topics <i className="fa-chevron-down"></i>
                    </button>
                </div>
            ...
            <div className="container mx-auto flex flex-wrap py-6">
                ...
                <section className="w-full md:w-2/3 flex flex-col items-center px-3">
                    ...
                    <article className="flex flex-col shadow my-4">
                        ...
                        <div className="bg-white flex flex-col justify-start p-6">
                            <button className="text-blue-700 text-sm font-bold uppercase pb-4">Technology</button>
                            <button className="text-3xl font-bold hover:text-gray-700 pb-4">Lorem Ipsum Dolor Sit Amet Dolor Sit Amet</button>
                            <p className="text-sm pb-8">
                                By <button className="font-semibold hover:text-gray-800">David Grzyb</button>, Published on April 25th, 2020
                            </p>
                    ...
                    <div className="w-full flex pt-6">
                        <button className="w-1/2 bg-white shadow hover:shadow-md text-left p-6">
                        ...
                        <button className="w-1/2 bg-white shadow hover:shadow-md text-right p-6">
                    ...
                    <div className="w-full flex flex-col text-center md:text-left md:flex-row shadow bg-white mt-10 mb-10 p-6">
                        <div className="w-full md:w-1/5 flex justify-center md:justify-start pb-4">
                            <img alt="Example" src="https://source.unsplash.com/collection/1346951/150x150?sig=1" className="rounded-full shadow h-32 w-32" />
                        </div>
                ...
                <aside className="w-full md:w-1/3 flex flex-col items-center px-3">
                    ...
                    <div className="w-full bg-white shadow flex flex-col my-4 p-6">
                        ...
                        <button className="w-full bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-2 py-3 mt-4">
                            Get to know us
                        </button>
                    </div>
                    ...
                    <div className="w-full bg-white shadow flex flex-col my-4 p-6">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=1" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=2" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=3" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=4" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=5" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=6" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=7" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=8" />
                            <img alt="Example" className="hover:opacity-75" src="https://source.unsplash.com/collection/1346951/150x150?sig=9" />
                        </div>
                        <button className="w-full bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-2 py-3 mt-6">
